...
const Home1 = () => {
  return (
    <div className="flex flex-col justify-center items-center px-4 py-28 ">
      <img src={earthier} alt="logo" className="w-[300px] h-auto flex justify-center" />
      <div className="h-140 w-35 text-center">
        ...
        <p className="text-center">
          ...
          farmers<br/> to make world-class products, develop a sustainable
          value-chain to scale up, <br/>and provide efficient logistic support to
          deliver worldwide.
        </p>
      </div>
    </div>
