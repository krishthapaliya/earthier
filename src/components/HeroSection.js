  ...
  return (
    <div className="flex flex-col">
      ...
      <div className=" flex flex-row justify-center   gap-[20px]  ">
        <img src={phone1} alt="photo1" className="w-[267px] h-[540.25px] pt-[80px] "
        />
        <img src={phone2} alt="photo2" className="w-[267px] h-[540.25px]  " />
        <img src={phone3} alt="photo3" className="w-[267px] h-[540.25px] pt-[80px]  "
        />
        <img src={phone4} alt="photo4" className="w-[267px] h-[540.25px] pt-[80px] "
        />
      </div>
      <div className="bg-green-200 w-full pl-9 flex flex-row items-center justify-between">
       ...
       <p className="text-gray-600 text-lg" >Join our 22,000+ community today!</p>
       </div>
         <img src={trueelements} alt="True Elements" className="h-12" />
          ...
          <img src={fulprasad} alt="Phool Prasad" className="h-[80px] w-[184.75px] " />
