  ...
  return (
    <div className="flex justify-between  gap-10  px-[130px] py-16 ">
      ...
      <div className="items-center py-[130px] ">
        ...
        We support your pursuit of wellness, involving a combination of <br/>lifestyle choices, self-care practices, and a proactive approach to<br/> overall well-being. </p>
