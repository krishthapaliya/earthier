...
const FAQSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        " Yes, Earthiers payment system is secure. They use industry-standard encryption and security protocols to ensure that all transactions and sensitive information are protected.",
    },
    {
      question: "Can I track my order?",
      answer:
        "Yes, Earthier typically provides order tracking services to allow customers to track their orders from the time of purchase until delivery.",
    },
    {
      question: "Are there any hidden fees with deliveries?",
      answer:
        "Earthier strives to be transparent with its pricing, including delivery fees. Typically, they will clearly outline any delivery fees or charges during the checkout process before you confirm your order.",
    },
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <p className="text-center mt-2 mb-8">
        Get the answers to your questions about Earthier.
      </p>
